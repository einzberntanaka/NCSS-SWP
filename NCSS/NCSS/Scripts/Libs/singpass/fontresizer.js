...
var originalsize = $("body").css('font-size').replace('px', '').replace('px', '');
	...
	$(document).ready(function(){
		//fix for uat 297
			 $("#font-big").fontscale(".form-notification,.error,button,a,p,em,h1,h2,h3,h4,h5,h6,body,span,li,.header,.footer--update,.footer--links,font,option,table","up",{unit:"px",increment:1});
			 $("#font-small").fontscale(".form-notification,.error,button,a,p,em,h1,h2,h3,h4,h5,h6,body,span,li,.header,.footer--update,.footer--links,font,option,table","down",{unit:"px",increment:1});
			 $("#font-normal").fontscale(".form-notification,.error,button,a,p,em,h1,h2,h3,h4,h5,h6,body,span,li,.header,.footer--update,.footer--links,font,option,table","reset");
			});
...
(function($) {
  ...
  $.fn.fontscale.reset = function( object, settings ) {
	  $(".nav").css("min-height" , "72px");
	  $("#myAccountMenu .sub-menu").css("min-height" , "23px");
    ...
    var fontsizePage = (delta + '/' + diff);
    
    if (fontsizePage=="1/1" || fontsizePage =="1/2" || fontsizePage=="1/3" || fontsizePage=="2/0" || fontsizePage=="3/0" || fontsizePage=="-1/3"){
    	
    	if($("#myAccountMenu").hasClass("menuSelected")){
    		 if (fontsizePage =="1/1" || fontsizePage =="1/2" || fontsizePage=="1/3" || fontsizePage=="2/0" || fontsizePage=="3/0" || fontsizePage=="-1/3"){
    		$(".nav").css("min-height" , "102px");
    		$("#myAccountMenu .sub-menu").css("min-height" , "48px");
    		 }
    	...
    	$("#myAccountMenu").hover(function(){ 
    		$(".nav").css("min-height" , "102px");
			 $("#myAccountMenu .sub-menu").css("min-height" , "48px");
    	/*	if (fontsizePage=="1/2" || fontsizePage=="1/3"){
			 $(".nav").css("min-height" , "102px");
			 $("#myAccountMenu .sub-menu").css("min-height" , "48px");
    		} else {*/
    		///	$(".nav").css("min-height" , "76px");
   			// $("#myAccountMenu .sub-menu").css("min-height" , "23px");
    	 ...
    	 if($("#servicesMenu").hasClass("menuSelected")){
    ...
    if((delta > 0 && diff < 3) || (delta < 0 && diff > -3)) {
